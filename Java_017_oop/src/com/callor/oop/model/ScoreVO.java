 ...
 *  getintKor() method는 intKor 인스턴스에서 값을 읽기
 *  기능을 한다는 것을 알 수 있다.
 * 
 *  코드 내용이 어떠한지 몰라도 
...
public class ScoreVO {
	 ...
	 * private 로 선언하여 직접 접근 할 수 없도록 만든다.
	 * 
	 ...
	 *  intEng 변수의 값을 읽지도 못하는 상황이 발생
	 *  intEng 변수의 값을 저장한 후 읽을수 있어야 되는데
	 *  intEng 변수에 값을 읽기 위해서 getIntEng()라는 메서드를
	 *  또 하나 선언 해 둔다. 
	 */
