...
public class CartServiceImplV1 implements CartService{
	...
	/*
	 * ImplV1 에서 inputCart() method를 사용하여 
	 ...
	 * 또한 상속 받은 클래스에서는 해당 변수(객체)를
	 * 		선언해서는 안된다. 
	 *  
	 */
	protected List<CartVO> cartList;
	
	private final Scanner scan;	// final은 통상 public static final로 사용
	...
	public void inputCart() {
		...
		System.out.println("구매자 이름을 입력 하세요");
		System.out.print(">> ");
		String strUserName = scan.nextLine();
		
		System.out.println("추가 할 상품이름을 입력하세요");
		System.out.print(">> ");
		String strProductName = scan.nextLine();
		
		System.out.println("추가 할 상품의 구매 수량을 입력하세요");
		...
		System.out.println("추가 할 상품의 구매 금액을 입력하세요");
		Integer intPrice = 0;
		while(true) {
			System.out.print(">> ");
	...
	private void printHeader() {
		System.out.println(Values.dLine);
		System.out.println("구매자\t상품명\t단가\t수량\t금액\t합계");
		System.out.println(Values.sLine);
}
