...
public class List_02 {
	 ...
	 * 3. 처음생성할때 몇개의 데이터를 저장할지 결정하지 않고
...
//		nums[3] = 30f; // == 30.0f
		...
		// 공통 type 의 ArrayList 객체 생성
		// list1 객체에 여러 type의 데이터를 추가 하여
		// 관리하겠다. 라는 의미
		ArrayList list1 = new ArrayList(); // 자바 이전버전에선 오류 발생, 버전에 따라 다름
		list1.add(3); // 정수
		list1.add("대한민국"); // 문자열
		...
		//		추가할 수 있다.
		// <String> : Generic type
		// 		strList1은 ArrayList 객체 이지만
		//		여기에는 문자열만 저장하도록 하겠다.
		// 		Generic type 은 int, float, long, double 등은 사용 불가
		//		Generic type 은 Integer, Float, Long, Double, String 등 을 
		//	     사용해야 한다.
		// 		Generic type 은 VO 클래스를 사용할 수 있다.
