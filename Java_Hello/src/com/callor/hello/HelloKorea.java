...
public class HelloKorea {
	...
	public static void main(String[] args) {
		...
		/*
		 * Console 출력문 ""(문자열 인용문, Double Qute. Mark) - "" 표시 내의 내용을 그대로 Console에 출력 ""
		 * 로 묶인 내용을 '문자열, String' 이라고 한다. 숫자(정수, 실수 등등)는 숫자 그대로 수학적으로 해석한다. 산술(연산)식 1.
		 * 숫자 산술식 수학의 4칙연산을 수행하고 결과를 출력
		 * 
		...
		int y;
			...
			for (x = 2; x <= 9; x++) {
				for (y = 1; y <= 9; y++) {
					System.out.println("구구단 = "+ x+" * "+y+" = "+ (x * y));
